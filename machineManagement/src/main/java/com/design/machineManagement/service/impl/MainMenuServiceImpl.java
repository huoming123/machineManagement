...
import com.design.machineManagement.mapper.SubmenuMapper;
import com.design.machineManagement.mapper.UsersMapper;
import com.design.machineManagement.pojo.MainMenu;
import com.design.machineManagement.mapper.MainMenuMapper;
import com.design.machineManagement.pojo.Submenu;
import com.design.machineManagement.pojo.Users;
import com.design.machineManagement.service.MainMenuService;
...
public class MainMenuServiceImpl implements MainMenuService {
    ...
    public RestFulBean<List<MainMenu>> getMenuTree(Users user) throws Exception {
        ...
        try {
            Users users = usersMapper.getById(user.getId()); //根据id查找用户
